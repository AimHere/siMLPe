...
# Loads a single specified animation
class AnimLoader:
    
    def __init__(self, config, filename, startframe):

        self.filename = filename
        self.startframe = startframe

        self.h36_motion_input_length  = config.motion.h36_input_length
        self.h36_motion_target_length  = config.motion.h36_target_length
...
if __name__ == "__main__":
    ...
    dataloader = AnimLoader(config, args.file, args.start_frame)
